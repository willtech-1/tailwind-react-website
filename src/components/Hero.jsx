...
// import c1 from '../assets/cyber-bg.png'
    ...
    <div name='home' className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                <p className='text-2xl'>Valuable Security Solutions</p>
                <h1 className='py-3 text-5xl md:text-7xl font-bold'>Security Solutions</h1>
                <p className='text-2xl'>Servicing residential and commercial.</p>
