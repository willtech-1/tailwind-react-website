...
import bg from '../assets/gate.jpg'
import g1 from '../assets/gate-motors.jpg'
// import g2 from '../assets/gate.jpg'
import g3 from '../assets/gate2.jpg'
import g4 from '../assets/gate3.jpg'
import g5 from '../assets/gate4.jpg'
import g6 from '../assets/gate4.jpg'
import g7 from '../assets/gate4.jpg'
  ...
  <div className='w-full mt-24'>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          <div className='px-4 py-12'>
              <h2 className='text-3xl pt-8 text-slate-300 uppercase text-center'>Gate Motors</h2>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      ...
                      <h3 className='font-bold text-2xl my-6'>Gate Motors</h3>
                      <img src={g1} alt='img'/>
